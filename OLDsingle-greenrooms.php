		...
		<div id="content-area" class="clearfix">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post' ); ?>>
					<?php if ( ( 'off' !== $show_default_title && $is_page_builder_used ) || ! $is_page_builder_used ) { ?>
						<div class="et_post_meta_wrapper">
							<h1 class="greenroom-entry-title"><?php the_title(); ?></h1>
				...
				<?php 	}
					...
					?>
					<!-- Jitsi Script -->
					<script src="https://showtime.ihackonline.com/external_api.js"></script>
						<script>
							var domain = "showtime.ihackonline.com";
							var options = {
								roomName: "<?php echo get_post_meta($post->ID, 'JitsiChannel', true); ?>",
								interfaceConfigOverwrite: { APP_NAME: 'iHack Showtime' },
								width: 800,
								height: 450,
