...
/* 	CHANGE HISTORY
	...
	v9  Allow custom fields to appear even when using ACF (Advanced Custom Fields)
...
//        'post_type' => 'page',
    ...
    if ($subpages->have_posts()) :
        ...
        while ($subpages->have_posts()) : $subpages->the_post();
            ...
            $output .= '<div class="teamContainer"><a class="teamName" href="' . get_permalink() .'">' . get_the_post_thumbnail($post_id,'thumbnail',array(320,180)). '<div class="teamTitle">' . get_the_title() .'</div></a>';
...
// v8 - actions for handling shortcodes
...
function airworks_announcement() {
    echo do_shortcode( '[jquery_latest_news_ticker postid="5404"]' );
    die(); 
} 